...
type
  ...
  napi_env* {.importcpp: "napi_env", header: "js_native_api_types.h" .} = pointer
  napi_value* {.importcpp: "napi_value", header: "js_native_api_types.h" .} = pointer
  napi_ref* {.importcpp: "napi_ref", header: "js_native_api_types.h" .} = pointer
  napi_handle_scope* {.importcpp: "napi_handle_scope", header: "js_native_api_types.h" .} = pointer
  napi_escapable_handle_scope* {.importcpp: "napi_escapable_handle_scope", header: "js_native_api_types.h" .} = pointer
  napi_callback_info* {.importcpp: "napi_callback_info", header: "js_native_api_types.h" .} = pointer
  napi_deferred* {.importcpp: "napi_deferred", header: "js_native_api_types.h" .} = pointer
